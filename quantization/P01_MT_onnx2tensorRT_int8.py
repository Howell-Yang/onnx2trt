...
MODEL = "/apdcephfs/private_howellyang/onnx2trt/model_T01/model.onnx"
...
# 把量化的不太好的算子送回 FP32
# QS.dispatching_table.append(operation="Concat_2420", platform=TargetPlatform.FP32)
...
with ENABLE_CUDA_KERNEL():
    ...
    with engine.create_execution_context() as context:
        inputs, outputs, bindings, stream, _ = trt_infer.allocate_buffers(
            context.engine
        )
