...
if __name__ == "__main__":
    import os
    calibration_files = glob.glob(os.path.join("/mapai/howellyang/code/onnx2trt/calib_images_2k/", '*.jpg'))
    calibration_files += glob.glob(os.path.join("/mapai/howellyang/code/onnx2trt/calib_images_2k/", '*.png'))
    # onnx_path = "/mapai/howellyang/code/road-service/road_service/engine/mod_road_multi_tasks/model-bak/RMTNet_release20220609.onnx"
    onnx_path = "/mapai/howellyang/code/onnx2trt/RMTNet_release20220609_mm2conv.optimized.balanced.onnx"
    ...
    with trt.Builder(TRT_LOGGER) as builder, builder.create_network((EXPLICIT_BATCH)) as network, trt.OnnxParser(network, TRT_LOGGER) as parser:
        ...
        print("====dir(trt.LayerType)====", dir(trt.LayerType))
        print("====dir(trt)====", dir(trt))
        print("====dir(trt.DataType)====", dir(trt.DataType))
        # for i in range(network.num_layers):
        #     if network.get_layer(i).type == trt.LayerType.CONCATENATION:
