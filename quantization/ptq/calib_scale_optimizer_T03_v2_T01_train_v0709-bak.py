    ...
    def infer_with_onnx(self, onnx_model="", SAMPLES=None, output_node=None):
        ...
        if isinstance(onnx_model, str):
            sess = onnxruntime.InferenceSession(
                onnx_model, providers=onnxruntime.get_available_providers())
        else:
        ...
        print("creating session finished")
    ...
    def process(self):
        ...
        while len(self.next_to_quant) > 0:
            ...
            best_cosine, best_model, best_scale = self.search_scale(
                ...
                scales,
                performences,
                search_scales=[100] if self.debug else [100, 99.995, 99.95, 99.5, 99.0],
            )
