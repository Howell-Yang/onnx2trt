...
fp32_model = "/apdcephfs/private_howellyang/road_service_app/LaneModel/onnx_infer/model/epoch_390_mm2conv.opt.onnx"
onnx_updated_model_path = fp32_model.replace(".onnx", ".weight_quantized_v4.onnx")
int8_qat_model = "/apdcephfs/private_howellyang/road_service_app/LaneModel/onnx_infer/model/epoch_390_mm2conv.opt_int8.onnx"
